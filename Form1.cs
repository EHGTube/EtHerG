...
namespace EtHerG
{
    public partial class Form1 : Form
    {
        ...
        private System.Timers.Timer initTimer; //Timer after which it will run certain functions on startup
        ...
        private void initvoid()
        {
            if (firstCon == false)
            {
                ...
                // Remove the initTimer after Testing!!!
